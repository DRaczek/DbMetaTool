...
>  W pliku DatabaseBuilder.cs aby utworzyć bazę musiałem zdefiniować connection string który zawiera sztywno wpisane hasło i użytkownika. Aby aplikacja działała poprawnie zaleca się wpisać w Properties/launchSettings.json własne dane dostępowe do bazy danych lub na sztywno w kodzie.
...
![Visitors](https://visitor-badge.laobi.icu/badge?page_id=DRaczek.DbMetaTool)
